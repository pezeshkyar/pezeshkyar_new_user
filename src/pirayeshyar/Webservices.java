			...
			try{
				if(db.isHaveSecretaryPermission(username, password, officeId)){
					if(!db.isAnyoneReserveTaskGroup(taskGroupId)){
						...
						res = "شما اجازه تغییرنام این گروه را ندارید زیرا قبلاً حداقل یک ن�?ر در این گروه نوبت رزرو کرده است";
					}
				} else {
			...
			try{
				if(db.isHaveSecretaryPermission(username, password, officeId)){
					if(!db.isAnyoneReserveTaskGroup(taskGroupId)){
						...
						res = "شما اجازه پاک کردن این گروه را ندارید زیرا قبلاً حداقل یک ن�?ر در این گروه نوبت رزرو کرده است";
					}
				} else {
					res = "شما مجوز دسترسی به این بخش را ندارید";
				}
			...
			try{
				if(db.isHaveSecretaryPermission(username, password, officeId)){
					if(!db.isAnyoneReserveTask(taskId)){
						...
						res = "شما اجازه  تغییرنام این عملیات را ندارید زیرا قبلاً حداقل یک ن�?ر در این گروه نوبت رزرو کرده است";
					}
				} else {
					res = "شما مجوز دسترسی به این بخش را ندارید";
				}
			...
			try{
				if(db.isHaveSecretaryPermission(username, password, officeId)){
					if(!db.isAnyoneReserveTask(taskId)){
						...
						res = "شما اجازه پاک کردن این عملیات را ندارید زیرا قبلاً حداقل یک ن�?ر در این گروه نوبت رزرو کرده است";
					}
				} else {
					res = "شما مجوز دسترسی به این بخش را ندارید";
				}
