...
public class PersianCalendar extends GregorianCalendar {
	...
	/**
	 * 
	 * @return Integer Number of the day in week (from 0 to 6)
	 */
	...
	public String getNumberInPersianChars(int a){
		String res = "";
		String neg = "";
		if(a < 0) {
			neg = "-";
	...
	public String getPersianLongDate() {
		String day = getNumberInPersianChars(this.persianDay);
		String year = getNumberInPersianChars(this.persianYear);
		return getPersianWeekDayName() + " " + day + " " + getPersianMonthName() + " " + year;
	}
